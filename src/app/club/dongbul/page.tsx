    ...
    <Wrapper>
      <ClubInfoContainer>
        ...
        <ClubDescriptionContainer>
          <span>동국대학교 불교 동아리로, 불교의 가르침을 바탕으로 한 다양한 활동을 진행합니다. 불교에 대한 이해와 신앙을 깊이 있게 쌓아가는 동시에, 동아리원 간의 유대감을 높이고 다양한 사회 공헌 활동을 통해 사회에 기여하는 것을 목표로 하고 있습니다. </span>
          <hr/>
          <span>동아리 회원들을 위해 다양한 물품 대여 시스템을 운영하고 있습니다. 명상 도구, 불교 서적, 템플 스테이 용품 등 다양한 물품을 대여할 수 있어, 불교 활동에 필요한 모든 준비를 지원합니다. 언제든 신행 활동에 필요한 물품을 대여하세요!</span>
        </ClubDescriptionContainer>
        <Line />
      </ClubInfoContainer>
